<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="Sistema_VENTAS.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="Sistema_VENTAS" %>
